...
export class MandatoryCardPostComponent
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  private reviseExpireDate(): void {
    ...
    if (this.name.includes("Medical")) {
      ...
      if (
        this.firestoreUserService.getFirestoreUser().role == roleName.cabinCrew
      )
